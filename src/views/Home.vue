        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La propuesta de proyecto transforma ideas en planes viables mediante análisis de necesidades, viabilidad, planificación y gestión de recursos. El ejemplo "SanoDelight" aborda la demanda de panadería saludable con estrategias como tiendas físicas, en línea y sostenibilidad. Los componentes clave incluyen problema, objetivos, mercado y estrategias. La evaluación de impacto utiliza indicadores como VAN, TIR y relación costo-beneficio. Los criterios de eficiencia y equidad aseguran uso óptimo de recursos, máxima rentabilidad y distribución justa de beneficios con inclusión social y sostenibilidad.
